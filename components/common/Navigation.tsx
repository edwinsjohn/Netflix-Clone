...
export default function HomeNavigation() {
  ...
  return (
    <div className=" flex flex-wrap tracking-wide w-[100%] text-netflix_text_white_light justify-between fixed bg-gradient-to-b from-[rgba(20,20,20,.5)] to-transparent z-50 ">
      <div className="ml-16 flex">
        <div className="py-6 relative w-[92px]">
        ...
        <div
          ...
          className="relative mx-10 text-[8px] py-4 md_new:hidden"
        >
      ...
      <div className="mr-16 flex my-6 max-lg_new:scale-95">
        <div className="p-1 mx-2">
          <Image src={search} alt="search" />
        </div>
        <h1 className="text-[15px] p-1 mt-[3px] max-lg_new:hidden">Children</h1>
